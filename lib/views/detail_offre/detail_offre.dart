...
class _DetailOffreState extends State<DetailOffre>
                                                                              ...
                                                                              children: [
                                                                                SizedBox(
                                                                                  ...
                                                                                  child: TextField(
                                                                                    ...
                                                                                    decoration: InputDecoration(
                                                                                      ...
                                                                                      errorText: widget._validate ? 'Value Can\'t Be Empty' : null,
                                                                                    ),
                                                                                  ),
                                                                                ),
                                                                                SizedBox(
                                                                                ...
                                                                                ElevatedButton(
                                                                                  ...
                                                                                  onPressed: () async {
                                                                                    ...
                                                                                    if (widget.commentController.text.isNotEmpty && widget._rating != 0) {
                                                                                      avis = await widget.createAvis(entreprise, user, comment, niveau);
  ...
  void _RatingModalBottomSheet(context) {
    int _rating1, _rating2, _rating3, _rating4, _rating5, _rating6 = 0;
