           ...
           key: _formKey,
            child: Column(
                              ...
                              child: 
                                  TextFormField(
                                    ...
                                    _formKey.currentState.validate();
                                          removeError(error: "this field should not be hamma");
                                        } 
                                        return null;
                                       },
                                      validator: (value) {
              ...
              Container(
                ...
                children: [
                 ...
                 onChanged: (value) {
                                        ...
                                        if (value.isNotEmpty) {
                                          _formKey.currentState.validate();
                                          removeError(error: "this field should not be empty");
                                        } 
                                        return null;
                                       },
                                      validator: (value) {
             ...
             Container(
                ...
                children: [
                  Text(
                    "Job Salary *",textAlign: TextAlign.left,
                     style: TextStyle(
                           fontWeight: FontWeight.w400,
                           fontSize: 16.0,
                           color: Colors.grey,
        ...
        WhitelistingTextInputFormatter.digitsOnly
              ...
              Container(
                ...
                children: [
                   ...
                   Text(
                    "Job Position *",textAlign: TextAlign.left,
                     style: TextStyle(
                           fontWeight: FontWeight.w400,
                           fontSize: 16.0,
                           color: Colors.grey,
              ...
              Container(
                ...
                children: [
                   ...
                   Text(
                    "Job Type *",textAlign: TextAlign.left,
                     style: TextStyle(
                           fontWeight: FontWeight.w400,
                           fontSize: 16.0,
                           color: Colors.grey,
                    ...
                    onTap: () {
                       if (_formKey.currentState.validate()) {
                          ...
                          "Content-Type": "application/json; charset=UTF-8"
                            ...
                            var url = Uri.parse(Utils.url + '/offre/Newoffre');
                        ...
                        http
                          ...
                          String message = reponse.statusCode == 201 ? "job added" : "error";
                           showDialog(
                            context: context,
                            builder: (context) {
                              return AlertDialog(
